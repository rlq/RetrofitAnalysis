 ...
 */
//包含  与HashMap结构类似
// 1 Entry 相关 LinkedKeySet LinkedValues LinkedEntrySet ---- size, clear, iterator, contains, remove, spliterator, forEach
// 2 Iterator 相关  LinkedHashIterator LinkedKeyIterator LinkedValueIterator LinkedEntryIterator -- hasNext, nextNode, remove,
    ...
    implements Map<K,V>
{
     ...
     * mean Map.Entry which is the compile time type of
     * entrySet()'s elements.
     * END Android-changed
     *

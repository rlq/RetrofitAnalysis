...
/**
 * A {@link com.java.util.Map} that further provides a <em>total ordering</em> on its keys.
...
public interface SortedMap<K,V> extends com.java.util.Map<K,V> {
    /**
     ...
     */
    com.java.util.Collection<V> values();
     ...
     *         sorted in ascending key order
     */
    Set<com.java.util.Map.Entry<K, V>> entrySet();
}

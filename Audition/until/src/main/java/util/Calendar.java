...
// END Android-changed: Removed ZoneInfo support
     ...
     * @since 1.6
     */
    public com.java.util.Map<String, Integer> getDisplayNames(int field, int style, Locale locale) {
        ...
        if (style == ALL_STYLES || isStandaloneStyle(style) || isNarrowFormatStyle(style)) {
            com.java.util.Map<String, Integer> map;
    ...
    private com.java.util.Map<String,Integer> getDisplayNamesImpl(int field, int style, Locale locale) {
        DateFormatSymbols symbols = DateFormatSymbols.getInstance(locale);
        String[] strings = getFieldStrings(field, style, symbols);
        if (strings != null) {
            com.java.util.Map<String,Integer> names = new com.java.util.HashMap<>();

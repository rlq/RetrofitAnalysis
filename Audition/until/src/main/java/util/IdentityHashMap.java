 ...
 * {@link com.java.util.HashMap} (which uses <i>chaining</i> rather than linear-probing).
 *
...
public class IdentityHashMap<K,V>
    ...
    implements com.java.util.Map<K,V>, java.io.Serializable, Cloneable
{
    /**
     ...
     */
    public IdentityHashMap(com.java.util.Map<? extends K, ? extends V> m) {
    ...
    public boolean equals(Object o) {
        if (o == this) {
            ...
            return true;
        } else if (o instanceof com.java.util.Map) {
            com.java.util.Map<?,?> m = (com.java.util.Map<?,?>)o;
    ...
    private abstract class IdentityHashMapIterator<T> implements com.java.util.Iterator<T> {
    ...
    private class EntryIterator
        extends IdentityHashMapIterator<com.java.util.Map.Entry<K,V>>
    {
        ...
        private class Entry implements com.java.util.Map.Entry<K,V> {
            private int index;
    ...
    private class KeySet extends AbstractSet<K> {
        public com.java.util.Iterator<K> iterator() {
        ...
        public boolean removeAll(com.java.util.Collection<?> c) {
            ...
            for (com.java.util.Iterator<K> i = iterator(); i.hasNext(); ) {
    ...
    private class Values extends com.java.util.AbstractCollection<V> {
        ...
        public boolean remove(Object o) {
            for (com.java.util.Iterator<V> i = iterator(); i.hasNext(); ) {
                if (i.next() == o) {
                    i.remove();
                    return true;
                }
    ...
    public Set<com.java.util.Map.Entry<K,V>> entrySet() {
        Set<com.java.util.Map.Entry<K,V>> es = entrySet;
        if (es != null)
            return es;
        else
    ...
    private class EntrySet extends AbstractSet<com.java.util.Map.Entry<K,V>> {
        ...
        public boolean removeAll(com.java.util.Collection<?> c) {
            Objects.requireNonNull(c);
            boolean modified = false;
            for (com.java.util.Iterator<Entry<K,V>> i = iterator(); i.hasNext(); ) {
                if (c.contains(i.next())) {
                    i.remove();
                    modified = true;
                }
        ...
        public <T> T[] toArray(T[] a) {
            ...
            for (int si = 0; si < tab.length; si += 2) {
                ...
                if ((key = tab[si]) != null) { // key present ?
                    ...
                    a[ti++] = (T) new com.java.util.AbstractMap.SimpleEntry<>(unmaskNull(key), tab[si + 1]);
                }
            }
            // fewer elements than expected or concurrent modification from other thread detected
            if (ti < size || expectedModCount != modCount) {
            ...
            if ((m = map) != null && (a = m.table) != null &&
                ...
                for (; i < hi; i += 2) {
                    ...
                    if (key != null) {
                        ...
                        @SuppressWarnings("unchecked") V v = (V)a[i+1];
                        action.accept
                            (new com.java.util.AbstractMap.SimpleImmutableEntry<K,V>(k, v));

        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     */
    public ArrayList(com.java.util.Collection<? extends E> c) {
     ...
     * @return <tt>true</tt> (as specified by {@link com.java.util.Collection#add})
     */
     ...
     * @throws NullPointerException if the specified collection is null
     */
    public boolean addAll(com.java.util.Collection<? extends E> c) {
        Object[] a = c.toArray();
        int numNew = a.length;
     ...
     * @see com.java.util.Collection#contains(Object)
     */

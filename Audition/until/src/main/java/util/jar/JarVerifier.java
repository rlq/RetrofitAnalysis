...
class JarVerifier {
        ...
        if (!parsingBlockOrSF) {
            ...
            try {
                ...
                if (uname.endsWith(".SF")) {
                    ...
                    com.java.util.Iterator<SignatureFileVerifier> it = pendingBlocks.iterator();
                    while (it.hasNext()) {
    ...
    private com.java.util.Map<URL, Map<CodeSigner[], CodeSource>> urlToCodeSourceMap = new com.java.util.HashMap<>();
    private com.java.util.Map<CodeSigner[], CodeSource> signerToCodeSource = new com.java.util.HashMap<>();
    private URL lastURL;
    private com.java.util.Map<CodeSigner[], CodeSource> lastURLMap;
    ...
    private synchronized CodeSource mapSignersToCodeSource(URL url, CodeSigner[] signers) {
        com.java.util.Map<CodeSigner[], CodeSource> map;
        if (url == lastURL) {
            map = lastURLMap;
        } else {
            map = urlToCodeSourceMap.get(url);
            if (map == null) {
                map = new com.java.util.HashMap<>();
    ...
    private com.java.util.Map<String, CodeSigner[]> signerMap;

    private synchronized com.java.util.Map<String, CodeSigner[]> signerMap() {
        if (signerMap == null) {
            /*
             ...
             */
            signerMap = new com.java.util.HashMap<>(verifiedSigners.size() + sigFileSigners.size());
    ...
    public synchronized Enumeration<String> entryNames(JarFile jar, final CodeSource[] cs) {
        final com.java.util.Map<String, CodeSigner[]> map = signerMap();
        final com.java.util.Iterator<com.java.util.Map.Entry<String, CodeSigner[]>> itor = map.entrySet().iterator();
        ...
        return new Enumeration<String>() {
            ...
            public boolean hasMoreElements() {
                ...
                while (itor.hasNext()) {
                    com.java.util.Map.Entry<String, CodeSigner[]> e = itor.next();
    ...
    public Enumeration<JarEntry> entries2(final JarFile jar, Enumeration<? extends ZipEntry> e) {
        final com.java.util.Map<String, CodeSigner[]> map = new com.java.util.HashMap<>();

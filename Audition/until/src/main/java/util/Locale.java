 ...
 * an {@link com.java.util.Iterator} over a {@link com.java.util.Collection} of language tags is treated as
...
public final class Locale implements Cloneable, Serializable {
     ...
     * </table>
     *
     * @see #filter(List, com.java.util.Collection, FilteringMode)
     * @see #filterTags(List, com.java.util.Collection, FilteringMode)
     *
     * @since 1.8
     */
    ...
    public static final class LanguageRange {
        ...
        */
         ...
         */
        public static List<LanguageRange> parse(String ranges,
                                                com.java.util.Map<String, List<String>> map) {
         ...
         * @see #parse(String, com.java.util.Map)
         */
    ...
    public static List<Locale> filter(List<LanguageRange> priorityList,
                                      com.java.util.Collection<Locale> locales,
                                      FilteringMode mode) {
     ...
     * {@link #filter(List, com.java.util.Collection, FilteringMode)} when {@code mode} is
    ...
    public static List<String> filterTags(List<LanguageRange> priorityList,
                                          com.java.util.Collection<String> tags,
                                          FilteringMode mode) {
     ...
     * Returns a list of matching languages tags using the basic filtering
     * mechanism defined in RFC 4647. This is equivalent to
     * {@link #filterTags(List, com.java.util.Collection, FilteringMode)} when {@code mode}

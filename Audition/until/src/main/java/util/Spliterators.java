...
public final class Spliterators {
     ...
     * {@link com.java.util.Collection#iterator()} as the source of elements, and
     * reporting its {@link com.java.util.Collection#size()} as its initial size.
     *
     ...
     */
    public static <T> Spliterator<T> spliterator(com.java.util.Collection<? extends T> c,
                                                 int characteristics) {
     ...
     */
    public static <T> Spliterator<T> spliterator(com.java.util.Iterator<? extends T> iterator,
                                                 long size,
                                                 int characteristics) {
     ...
     * @throws NullPointerException if the given iterator is {@code null}
     */
    public static <T> Spliterator<T> spliteratorUnknownSize(com.java.util.Iterator<? extends T> iterator,
                                                            int characteristics) {
     ...
     */
    public static<T> com.java.util.Iterator<T> iterator(Spliterator<? extends T> spliterator) {
        Objects.requireNonNull(spliterator);
        class Adapter implements com.java.util.Iterator<T>, Consumer<T> {
     ...
     * (see {@link #spliterator(com.java.util.Iterator, long, int)}.  Depending on the
     ...
     * available to use.
     *
     * @see #spliterator(com.java.util.Iterator, long, int)
     * @since 1.8
     */
    ...
    static class IteratorSpliterator<T> implements Spliterator<T> {
        static final int BATCH_UNIT = 1 << 10;  // batch array size increment
        static final int MAX_BATCH = 1 << 25;  // max batch array size;
        private final com.java.util.Collection<? extends T> collection; // null OK
        private com.java.util.Iterator<? extends T> it;
        private final int characteristics;
        private long est;             // size estimate
        private int batch;            // batch size for splits
         ...
         * collection's {@link com.java.util.Collection#iterator()) for traversal,
         * and reporting its {@link com.java.util.Collection#size()) as its initial
         * size.
         *
         * @param c the collection
         ...
         *        source or elements.
         */
        public IteratorSpliterator(com.java.util.Collection<? extends T> collection, int characteristics) {
         ...
         * source or elements.
         */
        public IteratorSpliterator(com.java.util.Iterator<? extends T> iterator, long size, int characteristics) {
         ...
         * source or elements.
         */
        public IteratorSpliterator(com.java.util.Iterator<? extends T> iterator, int characteristics) {
            this.collection = null;
            this.it = iterator;
        ...
        public Spliterator<T> trySplit() {
             ...
             * potential speedup.
             */
            com.java.util.Iterator<? extends T> i;
            long s;
            if ((i = it) == null) {

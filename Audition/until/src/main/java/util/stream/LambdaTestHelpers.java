...
public class LambdaTestHelpers {
    ...
    public static void assertCountSum(com.java.util.Iterator<? super Integer> it, int count, int sum) {
        int c = 0;
        int s = 0;
        while (it.hasNext()) {
    ...
    public static void assertConcat(com.java.util.Iterator<Character> it, String result) {
    ...
    public static<T extends Comparable<? super T>> void assertSorted(com.java.util.Iterator<T> i) {
    ...
    public static<T> void assertSorted(com.java.util.Iterator<T> i, Comparator<? super T> comp) {
    ...
    public static<T> void assertUnique(com.java.util.Iterator<T> iter) {
        if (!iter.hasNext()) {
            return;
        }
    ...
    public static<T> void assertContents(Iterable<T> actual, Iterable<T> expected) {
        if (actual instanceof com.java.util.Collection && expected instanceof com.java.util.Collection) {
    ...
    public static<T> void assertContents(com.java.util.Iterator<T> actual, com.java.util.Iterator<T> expected) {
        assertEquals(toBoxedList(actual), toBoxedList(expected));
    }

    @SafeVarargs
    @SuppressWarnings("varargs")
    public static<T> void assertContents(com.java.util.Iterator<T> actual, T... expected) {
     ...
     */
    private static<T> List<T> toBoxedList(com.java.util.Iterator<T> it) {
    ...
    private static<T> com.java.util.Map<T, Integer> toBoxedMultiset(com.java.util.Iterator<T> it) {
        com.java.util.Map<Object, Integer> result = new com.java.util.HashMap<>();
        ...
        return (com.java.util.Map<T, Integer>) result;
    }

    @SuppressWarnings("unchecked")
    public static<T> com.java.util.Map<T, Integer> toBoxedMultiset(Spliterator<T> it) {
        com.java.util.Map<Object, Integer> result = new com.java.util.HashMap<>();
    ...
    public static<T> void assertContentsUnordered(com.java.util.Iterator<T> actual, com.java.util.Iterator<T> expected) {

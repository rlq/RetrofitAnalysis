 ...
 *     the life of a stream. Like an {@link com.java.util.Iterator}, a new stream
 ...
 * <ul>
 *     <li>From a {@link com.java.util.Collection} via the {@code stream()} and
 ...
 * {@link com.java.util.Collection#stream} and {@link com.java.util.Collection#parallelStream},
 ...
 * as {@link com.java.util.function.Function}, and are often lambda expressions or
 * method references.
 *
 ...
 * {@link java.util.stream.Collectors#groupingBy(Function, java.util.stream.Collector) groupingBy}:
 *
 * <pre>{@code
 ...
 * {@link com.java.util.Collection#stream()} or {@link java.util.Arrays#stream(Object[])}
 ...
 * {@link com.java.util.Iterator}; it describes a (possibly infinite) collection of
 ...
 * {@link java.util.Spliterators#spliteratorUnknownSize(Iterator, int)}.

...
public class LogManager {
    ...
    private final com.java.util.Map<Object,Integer> listenerMap = new com.java.util.HashMap<>();
        ...
        LogNode getNode(String name) {
            ...
            while (name.length() > 0) {
                ...
                if (node.children == null) {
                    node.children = new com.java.util.HashMap<>();
                }
    ...
    public void readConfiguration(InputStream ins) throws IOException, SecurityException {
        ...
        com.java.util.Map<Object,Integer> listeners = null;
        synchronized (listenerMap) {
            if (!listenerMap.isEmpty())
                listeners = new com.java.util.HashMap<>(listenerMap);
        }
        if (listeners != null) {
            assert Beans.isBeansPresent();
            Object ev = Beans.newPropertyChangeEvent(LogManager.class, null, null, null);
            for (com.java.util.Map.Entry<Object,Integer> entry : listeners.entrySet()) {
    ...
    private static class LogNode {
        com.java.util.HashMap<String,LogNode> children;
        ...
        void walkAndSetParent(Logger parent) {
            ...
            com.java.util.Iterator<LogNode> values = children.values().iterator();

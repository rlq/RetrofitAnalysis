...
class XmlSupport {
     ...
     *         results in an <tt>IOException</tt>.
     */
    static void exportMap(OutputStream os, com.java.util.Map<String, String> map) throws IOException {
        Document doc = createPrefsDoc("map");
        Element xmlMap = doc.getDocumentElement( ) ;
        xmlMap.setAttribute("MAP_XML_VERSION", MAP_XML_VERSION);

        for (Iterator<Map.Entry<String, String>> i = map.entrySet().iterator(); i.hasNext(); ) {
            com.java.util.Map.Entry<String, String> e = i.next();
            Element xe = (Element)
     ...
     *         constitute a valid XML document with the mandated document type.
     */
    static void importMap(InputStream is, com.java.util.Map<String, String> m)
        throws IOException, InvalidPreferencesFormatException
    {
        try {
            Document doc = loadPrefsDoc(is);

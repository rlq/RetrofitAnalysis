...
public abstract class AbstractPreferences extends Preferences {
     ...
     */
    private com.java.util.Map<String, AbstractPreferences> kidCache = new com.java.util.HashMap<>();
    ...
    private void removeNode2() throws BackingStoreException {
        synchronized(lock) {
            ...
            for (com.java.util.Iterator<AbstractPreferences> i = kidCache.values().iterator();
                 i.hasNext();) {
                try {
                    i.next().removeNode2();
                    i.remove();

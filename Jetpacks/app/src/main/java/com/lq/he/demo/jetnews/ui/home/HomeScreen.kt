...
package com.lq.he.demo.jetnews.ui.home
...
fun HomeScreen(openDrawer: () -> Unit) {
    val postTop = postsCN[3]
    val postsSimple = postsCN.subList(0, 2)
    val postsPopular = postsCN.subList(2, 7)
    val postsHistory = postsCN.subList(7, 10)
